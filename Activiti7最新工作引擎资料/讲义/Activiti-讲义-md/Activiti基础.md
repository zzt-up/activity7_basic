...
### 活动 Activity-->这个范围大一些（ACT_HI_TASKINST 和ACT_HI_ACTINST,历史表有个act 和task区别）
...
act_ru_execution   流程执行信息  当前执行到哪个任务上了 act_id 当前字段
...
任务负责人查询待办任务，选择任务进行处理，完成任务。（act_hi_taskinst和 act_task_actinst历史任务表就有结束时间了）
...
![image-20220405102138942](C:\Users\14034\Desktop\资料-最新工作流引擎Activiti7基础与进阶\Activiti7最新工作引擎资料\讲义\Activiti-讲义-md\assets\image-20220405102138942.png)

![image-20220405103044296](C:\Users\14034\Desktop\资料-最新工作流引擎Activiti7基础与进阶\Activiti7最新工作引擎资料\讲义\Activiti-讲义-md\assets\image-20220405103044296.png)

![image-20220405140550451](C:\Users\14034\Desktop\资料-最新工作流引擎Activiti7基础与进阶\Activiti7最新工作引擎资料\讲义\Activiti-讲义-md\assets\image-20220405140550451.png)
...
1)       使用repositoryService删除流程定义，**历史表信息**不会被删除

2)       如果该流程定义下没有正在运行的流程，则可以用普通删除。

如果该流程定义下存在已经运行的流程，使用普通删除报错，可用级联删除方法将流程及相关记录全部删除，**历史表信息**不会被删除。
...
//        5、通过repositoryService的方法，实现读取图片信息和bpmn信息，从流程定义表中获取文件和图片的文字
//        png图片的流
